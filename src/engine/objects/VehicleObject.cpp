...
void VehicleObject::ApplyEngineForce(float force)
{
    engineForce = force;
...
void VehicleObject::ApplySteer(float steerIncr)
{
    if (steerIncr != 0)
    {
...
void VehicleObject::Brake(float force)
{
    brakeForce = force;
...
void VehicleObject::Update()
{
    // TODO: Code to update vehicle's state
}

btTransform VehicleObject::GetTransform() const
{
...
std::string VehicleObject::debugStateSTR() 
{
